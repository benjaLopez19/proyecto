...
server.post('/crearProducto',(req:any,res:any)=>{
    ...
    if(calificacion==null || nombre==null || descripcion==null || categoria==null || stock==null){
        ...
        connection.query("INSERT INTO productos(id,stock,calificacion,nombre,descripcion,categoria)VALUES('"+null+"','"+stock+"','"+calificacion+"','"+nombre+"','"+descripcion+"','"+categoria+"')",(req1:any,resultados:any)=>{
            //console.log(resultados);
...
server.put('/modificarProducto',(req:any,res:any)=>{
    ...
    connection.query("UPDATE productos SET nombre = '"+nombre+"', stock = '"+stock+"', calificacion = '"+calificacion+"', descripcion = '"+descripcion+"', categoria = '"+categoria+"' WHERE productos.id = '"+id+"'",(req1:any,resultados:any)=>{
        console.log(resultados);
...
server.post('/crearUsuario',(req:any,res:any)=>{
    ...
    if(email==null || nombre==null || clave==null || region==null || comuna==null){
        ...
        connection.query("INSERT INTO usuarios(email,nombre,clave,region,comuna)VALUES('"+email+"','"+nombre+"','"+clave+"','"+region+"','"+comuna+"')",(req1:any,resultados:any)=>{
            console.log(resultados);
